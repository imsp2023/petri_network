...
class Place{
	...
	this.shape.shape.addEvent('mouseover', () => {
	    console.log('mouseover place state='+this.state);
	...
	this.shape.shape.addEvent("mouseleave", ()=> {
	    if(this.state == 'moving')
		return;
	...
	this.panel.addEvent("mouseover", (e)=>{
	    this.state = 'panel';
	});
	this.panel.addEvent("mouseleave", (e)=>{
	    this.state = '';
	});
