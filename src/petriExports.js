class PetriExports {
	...
	data.edges.forEach(e=>{
	    text += 'insert into workflow.edges (id_processes, edge) values ((select id from workflow.processes where process->>\'name\'=\''+name+'\'),\''+JSON.stringify(e)+'\' );'
	})
